...
double Random :: Exponential(double gamma) {
   // This function generates a random number from an exponential distribution with given mean and sigma
   double y=Rannyu();
   double x = - log(1-y)/gamma;
...
double Random :: Lorentzian(double Gamma, double center) {
   // This function generates a random number from a Gaussian distribution with given mean and sigma
   double y=Rannyu();
   double x = center+Gamma*tan(M_PI*(y-0.5));
